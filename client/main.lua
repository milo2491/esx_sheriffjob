...
function OpenSheriffActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'sheriff_actions', {
		...
		align    = 'top-left',
		elements = {
			{label = _U('sheriffmenue'), value = 'polizeimenu'},
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'handcuff' then
						...
						Citizen.Wait(3100)
						TriggerServerEvent('esx_sheriffjob:handcuff',
						GetPlayerServerId(closestPlayer))
		...
		elseif data.current.value == 'polizeimenu' then --Eigenes Menue
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'polizeimenu', {
				...
				elements = {
					...
					{label = _U('sheriff_mdt'), value = 'mdtoffnen'},
					{label = _U('status'), value = 'status'},
					{label = _U('request'), value = 'renfort'},
					{label = _U('sheriff_badge'), 	value = 'badge'},
                ...
                elseif action == 'badge' then
                    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'esx_sheriffBadge',{
                        css = 'sheriff',
                        title    = 'Polizeimarke',
                        align = 'top-right',
                        elements = {
                            {label = _U('check_sheriffbadge'), value = 'checkBadge'},
                            {label = _U('show_sheriffbadge'), value = 'showBadge'},
                        }
                    }, function(data, menu)
                        ...
                        if val == 'checkBadge' then
                            TriggerServerEvent('sheriffbadge:open', GetPlayerServerId(PlayerId()), GetPlayerServerId(PlayerId()))
                            ...
                            if distance ~= -1 and distance <= 3.0 then
                                ...
                                TriggerServerEvent('sheriffbadge:open', GetPlayerServerId(PlayerId()), GetPlayerServerId(player))
				...
				elseif action == 'boucliermenu' then	
					...
					local elements = {	
						...
						--{label = _U('shield_sheriff'), value = 'bouclier1'},	
